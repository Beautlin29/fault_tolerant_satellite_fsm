module top(I1, I2, I3, C1, C2, Sel, N1, N2);
    ...
    mux_16_1 a13 (x[13], I1, I2, I3, C1, C2, ~I1, ~I2, ~I3, ~C1, ~C2, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, Sel[28:25]);

    and_3 b5 (x[11], x[12], x[13], y[7]);
    or_3 c5 (x[11], x[12], x[13], y[8]);

    mux_8_1 aa4 (z[4], x[11], x[12], x[13], y[7], y[8], 1'bx, 1'bx, 1'bx,  Sel[24:22]);


    //PE5 --> ~I1.I3.C1.~C2
    mux_16_1 a14 (x[14], I1, I2, I3, C1, C2, ~I1, ~I2, ~I3, ~C1, ~C2, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, Sel[21:18]);
    mux_16_1 a15 (x[15], I1, I2, I3, C1, C2, ~I1, ~I2, ~I3, ~C1, ~C2, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, Sel[17:14]);
    mux_16_1 a16 (x[16], I1, I2, I3, C1, C2, ~I1, ~I2, ~I3, ~C1, ~C2, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, Sel[13:10]);
    mux_16_1 a17 (x[17], I1, I2, I3, C1, C2, ~I1, ~I2, ~I3, ~C1, ~C2, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, 1'bx, Sel[9:6]);

    and_4 b6 (x[14], x[15], x[16], x[17], y[9]);
    or_4 c6 (x[14], x[15], x[16], x[17], y[10]);

    mux_8_1 aa5 (z[5], x[14], x[15], x[16], x[17], y[9], y[10], 1'bx, 1'bx, Sel[5:3]);

    //N2
    and_3 b7 (z[3], z[4], z[5], zz[3]);
    or_3 c7 (z[3], z[4], z[5], zz[4]);
    mux_2_1 aaa2 (N2, zz[3], zz[4], Sel[2]);
